...
# 画素数を表示サイズに合わせる (ADR 012、実装済み・実機確認は未)
...
1. 横画面の列数と間隔 — 8 列・spacing 12dp が実際どう見えるか
2. サムネイルの鮮明さ — 155px で粗くないか
3. PDF のページ送り — ログの png が 2.4 秒からどこまで落ちたか
4. スクロールのガタつき — デコード量が 60 分の 1 になった効果
